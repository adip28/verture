package com.example.adipermana.hidroponik.adapter;
...
import design.Beranda.LoadingFeedItemView;
...
public class FeedAdapter extends RecyclerView.Adapter<RecyclerView.ViewHolder> {
        ...
        cellFeedViewHolder.ivFeedCenter.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                if (context instanceof Beranda) {
                    ((Beranda) context).showLikedSnackbar();
                }
            }
        });
    ...
    public static class CellFeedViewHolder extends RecyclerView.ViewHolder {
        ...
        public void bindView(FeedItem feedItem) {
            ...
            ivFeedCenter.setImageResource(R.drawable.pagi);
            ivFeedBottom.setImageResource(adapterPosition % 4 == 0 ? R.drawable.img_feed_bottom_1 : R.drawable.img_feed_bottom_2);
